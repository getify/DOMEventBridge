...
// shim for Object.isArray() in non-ES5
if (!Object.isArray){Object.isArray = function(obj){return Object.prototype.toString.call(obj) === "[object Array]";};}
...
(function(global){
	...
	function bridgeFrom(sel,elems,evts) {
		...
		else if (Object.isArray(elems)) elems = elems.join(", ");
		if (evts && Object.isArray(evts)) evts = evts.join(" ");
